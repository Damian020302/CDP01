...
defmodule P01 do
  ...
  """
  def cuadruple(n) when is_number(n), do: n * 4

  @doc """
  Devuelve el sucesor un número
  """
  def sucesor(n) when is_number(n), do: n + 1

  @doc """
  Encuentra el máximo entre dos números
  """
  def maximo(n1, n2) when is_number(n1) and is_number(n2), do: (if n1 > n2, do: n1, else: n2)

  @doc """
  Suma dos números
  """
  def suma(n1, n2) when is_number(n1) and is_number(n2), do: n1 + n2

  @doc """
  Resta el segundo número del primero
  """
  def resta(n1, n2) when is_number(n1) and is_number(n2), do: n1 - n2

  @doc """
  Multiplica la multiplicación de conjugados
  """
  def multiplicacionConjugados(n1, n2) when is_number(n1) and is_number(n2), do: n1*n1 - n2*n2
  ...
  """
  def absoluto(n) when is_number(n), do: (if n >= 0, do: n, else: -n)
